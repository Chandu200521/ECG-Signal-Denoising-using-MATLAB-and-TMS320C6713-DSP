...
% 9. CHEBYSHEV TYPE-2 HIGH PASS FILTER DESIGN
...
title(['Chebyshev Type-2 HPF (Order=',...
       num2str(order),...
       ', Rp=',num2str(Rs),' dB)']);
...
% Residual noise/error after filtering
residual_noise = ecg_filtered - ecg_clean;

% Remaining noise power
